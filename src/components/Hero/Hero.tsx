  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div>
        ...
        <button className="mt-8 ml-[4px] px-3 py-1 rounded-full bg-gradient-to-r from-[#FB8500] to-[#d62828] flex flex-row items-center drop-shadow-md hover:drop-shadow-xl">
          <BiMailSend className="px-2" size={40} color="#FFFF" />
          <span className="pr-2 font-bold dark:text-white">
            Contact me
          </span>
        </button>
      </div>
